 ...
 * @Author: chenrui
 * @Description:
 * @Date: Created in 16:56 2020/11/9.
 */
...
//        }
        ...
        // 指定要上传的文件
        File localFile = new File("/Users/chenrui/Downloads/bbb.jpg");

        // 指定要上传到 COS 上对象键
        String key = Constants.COS_IMG_PATH + "ccc.jpg";
        PutObjectRequest putObjectRequest = new PutObjectRequest(Constants.COS_BUCKET_NAME, key, localFile);
